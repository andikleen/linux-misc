...
static __devinitconst const struct v4l2_ioctl_ops timblogiw_ioctl_ops = {
...
static __devinitconst const struct v4l2_file_operations timblogiw_fops = {
	.owner		= THIS_MODULE,
	.open		= timblogiw_open,
...
static __devinitconst const struct video_device timblogiw_template = {
